...
public class CodeGenerator {
  ...
  public static void main(String[] args) {
    ...
    String projectPath = System.getProperty("user.dir") + "/lly";
    ...
    // ⼀、修改数据源
    dsc.setUrl("jdbc:mysql://localhost:3306/lly?useUnicode=true&characterEncoding=UTF8&useSSL=false");
